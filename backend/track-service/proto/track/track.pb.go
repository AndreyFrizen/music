...
func (x *NewTrack) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*NewTrack) ProtoMessage() {}

func (x *NewTrack) ProtoReflect() protoreflect.Message {
	mi := &file_track_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use NewTrack.ProtoReflect.Descriptor instead.
func (*NewTrack) Descriptor() ([]byte, []int) {
	return file_track_proto_rawDescGZIP(), []int{1}
}

func (x *NewTrack) GetTitle() string {
	if x != nil {
		return x.Title
	}
	return ""
...
func (x *NewTrack) GetDuration() int64 {
	if x != nil {
		return x.Duration
	}
	return 0
...
func (x *NewTrack) GetAlbumId() int64 {
	if x != nil {
		return x.AlbumId
	}
	return 0
...
var file_track_proto_goTypes = []any{
	...
	(*NewTrack)(nil),            // 1: track.NewTrack
	(*CreateTrackRequest)(nil),  // 2: track.CreateTrackRequest
	(*CreateTrackResponse)(nil), // 3: track.CreateTrackResponse
	(*GetTrackRequest)(nil),     // 4: track.GetTrackRequest
	(*GetTrackResponse)(nil),    // 5: track.GetTrackResponse
	(*UpdateTrackRequest)(nil),  // 6: track.UpdateTrackRequest
	(*UpdateTrackResponse)(nil), // 7: track.UpdateTrackResponse
	(*DeleteTrackRequest)(nil),  // 8: track.DeleteTrackRequest
	(*DeleteTrackResponse)(nil), // 9: track.DeleteTrackResponse
}
