...
const file_user_proto_rawDesc = "" +
	...
	"\x05token\x18\x01 \x01(\tR\x05token2\xdb\x02\n" +
	"\vUserService\x12?\n" +
	"\n" +
	...
	"\x10AuthenticateUser\x12\x1d.user.AuthenticateUserRequest\x1a\x1e.user.AuthenticateUserResponseB\aZ\x05/userb\x06proto3"
...
var file_user_proto_depIdxs = []int32{
	...
	9, // 9: user.UserService.AuthenticateUser:output_type -> user.AuthenticateUserResponse
